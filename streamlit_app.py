...
if "messages" not in st.session_state.keys(): # Initialize the chat messages history
    st.session_state.messages = [
            {"role": "system", "content": "You are an assistant that impersonates " + st.secrets.character + ". Keep your answers to the documentation provided, be friendly, ignore insults and bad language – do not hallucinate facts. Avoid using the name of your character multiple times and use the pronoun I to refer to yourself"} ,  # add context to the response
